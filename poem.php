...
<body>
       <div class="poem-body">
        ...
        <h1 class="welpoem"><span class="h1head">Read A Thousand books,and your words will flow like a River</span></h1></div>
        <div class="navtp" style="position:relative;">
            <nav style="--bs-breadcrumb-divider: '>'; "aria-label="breadcrumb">
             <ol class="breadcrumb">
               <li class="breadcrumb-item"><a href="blog.php">Home</a></li>
               <li class="breadcrumb-item active" aria-current="page">Poem</li>
             </ol>
           </nav>
       ...
       <div class="poem-disp" id="maindisp">
        ...
        <div >
            ...
            <div class="list-group opp p-2 ">
               ...
               <div class="poem-posts "><h2 >POEM POSTS</h2></div>
                ...
                $limit=3;
                $offset = ($page - 1) * $limit;
               $sql1="SELECT * FROM blog_sub WHERE submission_type='poem'LIMIT $offset,$limit";
               $res=$conn->query($sql1);
               ...
               if(mysqli_num_rows($res)>0)
               {
                ...
                while($poemposts = mysqli_fetch_assoc($res)){
                   ...
                   echo'
                    ...
                    <div class="blogs container"   style="margin-left:8rem;text-align:center;background-color:#EAEAEA;o><h1 style="padding-bottom:0.5rem;"><span style="color:#B34180;font-size:150%;text-decoration:underline;" class="post-headings">
              ...
              $sql="SELECT COUNT(*) from blog_sub WHERE submission_type='poem'";
